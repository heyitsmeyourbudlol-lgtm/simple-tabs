...
# Hub-relative so Mac verify + CLEAN overseer both see local scripts (hardcoded
# CLEAN path made _land_proof false on Mac → verify-gate red).
...
NEEDLES = [
    "last_cycle poison: verify_ok=True with failure_type=deferred",
    "last_cycle poison",
